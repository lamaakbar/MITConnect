-- Create idea_likes table for storing user reactions to ideas
...
CREATE TABLE IF NOT EXISTS idea_likes (
    ...
    user_id VARCHAR(255) NOT NULL, -- Using string for user ID to match auth
    idea_id UUID NOT NULL REFERENCES ideas(id) ON DELETE CASCADE,
    liked BOOLEAN NOT NULL, -- true for like, false for dislike
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE(user_id, idea_id) -- Prevent duplicate reactions per user per idea
);
...
-- Uncomment the following lines if you want to add sample reactions
/*
INSERT INTO idea_likes (user_id, idea_id, liked) VALUES
('user-123', 'your-idea-uuid-here', true),
('user-456', 'your-idea-uuid-here', false)
