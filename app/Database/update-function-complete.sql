-- Update the get_ideas_with_votes function to include poll data
-- Run this after the table fix script
...
SELECT COUNT(*) as total_ideas_with_polls FROM get_ideas_with_votes(); 