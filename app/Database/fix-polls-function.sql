-- Fix the get_ideas_with_votes function to use correct table names
-- Run this in your Supabase SQL editor

-- Drop the existing function
DROP FUNCTION IF EXISTS get_ideas_with_votes() CASCADE;
...
-- Test the function
SELECT 'Testing get_ideas_with_votes function...' as message;
SELECT COUNT(*) as total_ideas FROM get_ideas_with_votes();

-- Show any ideas with polls
SELECT 'Ideas with polls:' as message;
SELECT 
    i.title,
    i.status,
    p.question as poll_question,
