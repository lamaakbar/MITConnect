...
import { View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, FlatList, SafeAreaView, Platform, ActivityIndicator, Alert } from 'react-native';
                            ...
                            try {
                              ...
                              if (result.success) {
                                ...
                                router.push({
                                  ...
                                  params: { id: item.id, from: 'employee-home' }
                                });
                              } else {
